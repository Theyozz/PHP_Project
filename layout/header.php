      ...
      <div class="text-end">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            ?>    <li class="nav-item d-flex">
                    <a class="nav-link active text-light fw-light" aria-current="page" href="../login.php">Log in</a>
                    <span class="text-light d-flex align-items-center fw-light">/</span>
                    <a class="nav-link active text-light fw-light" aria-current="page" href="../signup.php">Sign up</a>
                  </li>
            <?php } ?>
          </ul>
      </div>
